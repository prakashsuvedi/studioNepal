...
export const INITIAL_SCENES: Scene[] = [
  {
    id: 'scene-1',
    title: 'Everest Sunrise Golden Peak 4K',
    duration: 5,
    ...
    mediaUrl: '/samples/everest_sunrise.mp4',
    thumbnailUrl: '/samples/everest_sunrise_thumb.jpg',
    mediaType: 'video',
    aspectRatio: '16:9',
    motion: 'pan_right',
    transition: 'fade',
  ...
  },
  {
    ...
    mediaUrl: '/samples/durbar_square.mp4',
    thumbnailUrl: '/samples/durbar_square_thumb.jpg',
    mediaType: 'video',
    aspectRatio: '16:9',
    motion: 'zoom_in',
    transition: 'dissolve',
  ...
  },
  {
    ...
    mediaUrl: '/samples/phewa_lake.mp4',
    thumbnailUrl: '/samples/phewa_lake_thumb.jpg',
    mediaType: 'video',
    aspectRatio: '16:9',
    motion: 'dolly',
